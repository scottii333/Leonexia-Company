  ...
  return (
    <main className="">
      ...
      <section className="h-auto w-full  flex flex-col md:flex-row">
        ...
        <div className="pb-20 h-[auto] min-w-[auto] md:w-[50%]  border bg-grid flex gap-3 flex-col items-center  ">
          {/* Top Section with building icon + loading bar */}
          <div className="mt-10 flex gap-2 p-1 w-[80%] h-[4.5rem]">
            {/* Building Icon */}
          ...
          <div className="w-[80%] bg-white/70 rounded-2xl shadow-sm border border-gray-200 p-6 text-center">
            {/* Title */}
            ...
            <div className="flex justify-between mt-3">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-sm font-medium text-gray-700">Assess</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-sm font-medium text-gray-700">Deploy</p>
              </div>
          ...
          <div className="w-[80%] p-4 rounded-xl border bg-white/70 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-lg">AI-Powered Enterprise</h3>
